...
sealed interface AppIntent : Intent {
	data class StartRegistration(val email: String, val name: String, val logsOptIn: Boolean) : AppIntent
	...
	class CreateSpaceIntent(val name: String, val picture: ByteArray?, val color: SpaceColor) : AppIntent
